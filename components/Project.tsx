...
function Projects() {
  ...
  return (
    <div className="relative z-0 mx-auto flex min-h-screen max-w-full flex-col items-center scrollbar justify-evenly overflow-hidden text-left md:flex-row">
      ...
      <div className="relative z-20 flex scrollbar-track-gray-400/20 scrollbar-thumb-[#F7AB0A]/80 scrollbar-thin w-full snap-x snap-mandatory overflow-y-hidden overflow-x-scroll">
        <div className="flex h-screen w-screen  flex-shrink-0 snap-center flex-col items-center justify-center space-y-5 object-contain p-20 md:p-44">
          <img
            ...
            className="mt-28 h-60 rounded-lg cursor-pointer"
          />
      ...
      <div className="absolute top-[30%] left-0 h-[350px] w-full -skew-y-12 bg-[#F7AB0A]/10" />
    </div>
  );
}
